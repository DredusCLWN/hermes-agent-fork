...
# especially). 120K chars ≈ 30K tokens — comfortably inside every supported
...
_FALLBACK_SUMMARY_MAX_CHARS = 6_000
_FALLBACK_PREVIOUS_SUMMARY_MAX_CHARS = 2_000
_FALLBACK_TURN_MAX_CHARS = 500
...
class ContextCompressor(ContextEngine):
    ...
    def __init__(
        ...
        self._compression_llm_cost_total: int = 0
        ...
        self._cumulative_tokens_saved: int = 0
