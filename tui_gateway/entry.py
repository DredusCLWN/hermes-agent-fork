...
def _log_signal(signum: int, frame) -> None:
    ...
    background thread (beep, status emitter, etc.)
    ...
    try:
        ...
        with open(_CRASH_LOG, "a", encoding="utf-8") as f:
            ...
            # background thread (write to broken stdout, etc.).
...
# silently whenever a *background* thread (playback chain,
...
def _log_exit(reason: str) -> None:
    ...
    triggered it — the main reason turns look like phantom
