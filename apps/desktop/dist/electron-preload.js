...
import_electron.contextBridge.exposeInMainWorld("hermesDesktop", {
  ...
  proxyFetch: (url, options) => import_electron.ipcRenderer.invoke("hermes:proxyFetch", url, options),
  ...
  toggleDevTools: () => import_electron.ipcRenderer.invoke("hermes:devtools:toggle"),
